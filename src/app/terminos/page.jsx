  ...
  return (
    <div className="w-[80%] mx-auto py-10">
      <div className="mx-auto bg-gray-200 p-10 rounded-lg shadow-lg">
        ...
        <p>
          Al acceder o utilizar el Sitio Web, usted reconoce que ha leído,
          comprendido y acepta quedar sujeto a estos Términos del Servicio. Si
          no está de acuerdo con estos términos, por favor no utilice este Sitio
          Web.
        </p>
        ...
        <ul className="list-disc pl-8 mt-2">
          <li>Liposucción</li>
          <li>Liposucción & Abdominoplastia</li>
          <li>Implantes Mamarios</li>
          <li>Levantamiento de Busto con Implantes</li>
          <li>Levantamiento de Busto sin Implantes</li>
          <li>Rinoplastia</li>
          <li>Mommy Makeover</li>
          <li>Abdominoplastia</li>
        </ul>
        <p className="mt-2">
          Tenga en cuenta que los detalles específicos sobre estos
          procedimientos, precios y promociones se pueden encontrar en el Sitio
          Web.
        </p>
        ...
        <ul className="list-disc pl-8">
          <li>
            Los usuarios de este Sitio Web se comprometen a proporcionar
          ...
          <li>
            Los usuarios no deben participar en actividades que puedan
            perjudicar o interrumpir la funcionalidad del Sitio Web.
          </li>
        </ul>
        ...
        <p>
          ...
          protegemos su información personal. Al utilizar este Sitio Web, usted
          acepta las prácticas descritas en nuestra Política de Privacidad.
        </p>
        ...
        <p>
          Todo el contenido en el Sitio Web, incluyendo texto, imágenes y
          logotipos, está protegido por las leyes de propiedad intelectual. Se
          prohíbe a los usuarios utilizar, modificar o distribuir cualquier
          contenido del Sitio Web sin el consentimiento previo por escrito.
        </p>
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2">10. Ley Aplicable</h2>
        <p>
          Estos Términos del Servicio se rigen y se interpretan de acuerdo con
          las leyes de [Zamora, Michoacán, México], sin tener en cuenta sus
          conflictos de leyes.
        </p>
